...
namespace Nickpsal\Component\Movielist\Administrator\View\Category;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(
            Text::_($isNew ? 'COM_MOVIELIST_CATEGORY_NEW' : 'COM_MOVIELIST_CATEGORY_EDIT'),
            'list'
        );
