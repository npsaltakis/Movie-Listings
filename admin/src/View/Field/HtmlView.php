...
namespace Nickpsal\Component\Movielist\Administrator\View\Field;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(
            Text::_($isNew ? 'COM_MOVIELIST_FIELD_NEW' : 'COM_MOVIELIST_FIELD_EDIT'),
            'list-2'
        );
